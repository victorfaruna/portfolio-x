...
const SocialItem = ({
  ...
  return (
    ...
    >
      ...
      <p className="text-color-1/60 text-[0.6rem]">{text}</p>
    </button>
  );
};
  ...
  return (
    <div className="w-full px-20 sm:px-8 my-[3.5rem] flex flex-col gap-6">
      ...
      <p className="w-full text-[0.6rem] font-firaCode text-color-1/60">
        ...
        technologies like React, Next.js, Node.js, Python, and React Native. I’m
        passionate about solving complex problems and delivering user-focused
        solutions.
      </p>
      ...
      >
        <button className="w-[180px] h-[40px] bg-color-1 text-[0.8rem] text-main italic rounded-full font-medium flex items-center justify-center">
          Projects
        </button>
        <button className="size-[40px] bg-color-1 flex items-center justify-center rounded-full text-main">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
      ...
      <div id="socials" className="flex items-center gap-2 flex-wrap">
        <SocialItem
